...
## PATTERN_NO_PASSES: NO_PASSES

*Note: This parameter is for advanced users*

Number of passes of a pattern before the robot halts

- Range: 0 999

## POSTHETADEGMAX: POSTHETADEGMAX
...
minimum theta in degrees before stop
...
Number of passes before stop

- Range: 0 999

## VERTICAL_NO_PASSES: VERTICAL_NO_PASSES

*Note: This parameter is for advanced users*

Number of full vertical passes before changing direction. (Also referred to as sub-passes; VERT_NO_PASSES+FS_NO_PASSES sub passes for a full pass)

- Range: 0 999

## FS_NO_PASSES: FS_NO_PASSES

*Note: This parameter is for advanced users*

Number of vertical passes near free surface

- Range: 0 999

## PATTERN_Max_depth: Max_depth

*Note: This parameter is for advanced users*

Max depth before starting upwards speed [m]

- Units: m

- Range: -999 0

## LATERAL_Max_depth: LAT_Max_depth
...
## FS_Max_depth: FS_Max_depth

*Note: This parameter is for advanced users*

Passes at free surface, typically from MIN_DEPTH to FS_MAX_DEPTH. For top of net cleaning. Max depth before starting upwards speed for FS pattern  [m]

- Units: m

- Range: -999 0

## PATTERN_min_depth: Min_depth

*Note: This parameter is for advanced users*

Min depth before starting downwards speed  [m]
...
type of diagonal : 0 = diag-up-diag, 1 = up-diag-up
...
## LATERAL_min_depth: LAT_Min_depth
...
distance in backward when stuck  [m]
...
distance forward after stuck point to decide we are unstuck

- Units: m

- Range: 0 1

## STUCK_MAXT: STUCK_MAXT
...
do we want a ramp when trying to move when stuck, 0=no, 1=yes
...
do we want manual like throttle when trying to move when stuck
...
maximum time to determine we are really stuck
...
Error tolerence when straighting up the vehicle.

- Units: deg

- Range: 0 180

## PATTERN_Speed_up: SPEED_UP

*Note: This parameter is for advanced users*

Set speed up. range from -100 to 100, where 0. = stop. Up is range from -100. to 0, down is range from 0 to 100.

- Range: -100 100

## PATTERN_Speed_down: SPEED_DOWN

*Note: This parameter is for advanced users*

Set speed down range from -100 to 100, where 0. = stop. Up is range from -100. to 0, down is range from 0 to 100.

- Range: -100 100

## PATTERN_Speed_left: SPEED_LEFT

*Note: This parameter is for advanced users*

Set speed left. range from -100 to 100, where 0. = stop.

- Range: -100 100

## PATTERN_Speed_right: SPEED_RIGHT

*Note: This parameter is for advanced users*

Set speed right. range from -100 to 100, where 0. = stop.

- Range: -100 100

## PATTERN_Speed_slow: SPEED_SLOW

*Note: This parameter is for advanced users*

Set speed slow. This is set to 0.51 to have a slow speed on the vehicle while it is straightining up the heading when changing state. range from -100 to 100, where 0. = stop.

- Range: -100 100

## PATTERN_Turn_angle: TURN_ANGLE

*Note: This parameter is for advanced users*

Set turn angle deviation from start point.  This is added and subtracted from starting point in roll/heading

- Units: deg

- Range: 0 90

## LATERAL_Turn_angle: LAT_TURN_ANGLE
...
offset in meter between two passes. When you complete a set of passes (VERT_NO_PASSES+FS_NO_PASSES), how much distance (horizontal) for the next set of passes.
...
Modify roll angle in stabilize/acro mode
...
Allows for printaing variables through statustext
...
Which direction should the passes be offset (left or right); pattern to the left = 1, to the right =2
...
current position along theta in degrees
...
parking depth for parking mode in meters
...
parking error for parking mode in meters : robot should stay between PARKING_DEPTH-PARKING_ERROR and PARKING_DEPTH+PARKING_ERROR

- Units: m

- Range: 0. 1

## PARK_FAR_DIST: PARK_FAR_DIST

*Note: This parameter is for advanced users*

parking far away distance: when further away from PARKING_DEPTH than this, apply standard throttle (SPEED_UP or SPEED_DOWN)

- Units: m

- Range: 0 2

## PARK_THROTTLE: PARK_THROTTLE

*Note: This parameter is for advanced users*

parking throttle applied in parking mode for correction of depth

- Units: %

- Range: 0 100

## MANUAL1_PARK2: MANUAL1_PARK2

*Note: This parameter is for advanced users*

when acro pattern is finished, switch to manual mode or parking mode ?
...
Change the tolerance for detecting if the vehicle is not moving
...
CURRENT PATTERN : Current autopilot the robot shall follow in acro mode

|Value|Meaning|
|:---:|:---:|
|1|verticalOneWay L/R|
|2|lateral L/R|
|3|vertTwoWay L/R|
|4|horizontal|
|5|horizontal PostContAlgo|
|6|vert PostContAlgo 2way|
|7|vert PostContAlgo 1way|
|8|diagonal|

## MAX_HORIZ_DIST: MAX_HORIZ_DIST

*Note: This parameter is for advanced users*

max horizontal distance for horizontal patterns in meters
...
transition duration for smoothed transitions in ms
...
roll precision for initial calibration of roll in centidegrees

- Units: cdeg

- Range: 0 200

## ROLL_CALIB_VEL: ROLL_CALIB_VEL

*Note: This parameter is for advanced users*

small velocity for roll calibration to avoid turning in place

- Range: 10 50

## Docking: Docking_heading

*Note: This parameter is for advanced users*

Docking heading angle for crawler [degree] ?

- Range: 0 360

## Docking: DOCKING_TOLERANCE

*Note: This parameter is for advanced users*

Docking tolerance for crawler [degree] ?
...
Interval between health check [minutes] ?
...
Time length of health check [seconds] ?

- Range: 0 60

## Reporting: REP_INTERVAL
...
## Avoidance: AVOID_OFFSET

*Note: This parameter is for advanced users*

offset when trying to avoid an obstacle

- Units: m

- Range: 0 2

## Avoidance: AVOID_ANGLE

*Note: This parameter is for advanced users*

turn angle when trying to avoid an obstacle

- Units: deg

- Range: 0 360

## Avoidance: AVOID_NB_OFFSET

*Note: This parameter is for advanced users*

nb of try of moving lateral of AVOID_OFFSET

- Range: 0 255

## Avoidance: AVOID_NB_TIME
...
base angle for diagonal pattern

- Units: deg

- Range: 0 90

## Diagonal: DIAG_TURN_ANGLE

*Note: This parameter is for advanced users*

turn angle for diagonal pattern
...
## PID_POS_KP: PID_POS_KP

*Note: This parameter is for advanced users*

kp coefficient for pid POS control algorithm

- Range: 0 10000

## PID_POS_TI: PID_POS_TI
...
## BF_NB_REPETITION: BF_NB_REPETITION

*Note: This parameter is for advanced users*

number of repetition of backflush
...
## TEST_THRUS_TH_2: TEST_THRUS_TH_2
...
## TEST_BRUSH_TH_2: TEST_BRUSH_TH_2
...
## TEST_BRUSH_NBPER: TEST_BRUSH_NBPER
...
for GPS mode, distance at which we apply GPS_THROTTLE and GPS_THRUS_TH

- Units: m

- Range: -200 200

## GPS_THROTTLE: GPS_THROTTLE

*Note: This parameter is for advanced users*

throttle for GPS mode
...
## JS_STEER_GAIN: Steering gain scalar

Scalar for gain on the steering channel

- Range: 0.5 4.0

## FWD_BRUSH_TH: FWD_BRUSH_TH
...
## BRUSH_GAIN_DEF: Default gain at boot for brush

Default gain at boot for brush, must be in range [JS_GAIN_MIN , JS_GAIN_MAX]

- Range: 0.1 1.0

## BRUSH_GAIN_MAX: Maximum brush gain
...
## AUTOSTART_FORCE: AUTOSTART_FORCE

*Note: This parameter is for advanced users*

set to 1 to force automatic start and disable conditionnal start

- Range: -254 255

## AUTOST_PATTERN: AUTOST_PATTERN

*Note: This parameter is for advanced users*

pattern used in autostart. negative value = previous pattern ?

- Range: -254 255

## AUTOST_LEFT1_R2: AUTOST_LEFT1_R2

*Note: This parameter is for advanced users*

LEFT1_RIGHT2 used in autostart, <=0 value = opposite of LEFT1_RIGHT2 ? >=3 same as LEFT1_RIGHT2

- Range: -254 255

## AUTOST_MIN_DEPTH: AUTOST_MIN_DEPTH

*Note: This parameter is for advanced users*

MIN_DEPTH used in autostart

- Units: m

- Range: -999 0

## AUTOST_MAX_DEPTH: AUTOST_MAX_DEPTH

*Note: This parameter is for advanced users*

MAX_DEPTH used in autostart

- Units: m

- Range: -999 0

## AUTOST_FS_DEPTH: AUTOST_FS_DEPTH

*Note: This parameter is for advanced users*

FS_MAX_DEPTH used in autostart
...
## ACRO_ROTAT_PAT: determine what to do in initialisation in acro mode after setting vertical direction

0 -> do nothing, 1 -> rotate to pattern target angle

|Value|Meaning|
|:---:|:---:|
|0|nothing|
|1|rotatePatTargetAngle|

## TEMP_CHECK: determine what to do in case of temperature too high
